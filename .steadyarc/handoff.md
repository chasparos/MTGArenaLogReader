...
- **Architecture artifact:** `docs/architecture/ui-consolidation-preparation.md` records the completed shell handoff; memory-scan architecture is defined initially in the current roadmap and durable notes.
